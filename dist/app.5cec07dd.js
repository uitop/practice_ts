...
function () {
  ...
  Router.prototype.getPathParam = function (path) {
    var param = path.match(/\d+/);
  ...
  Router.prototype.route = function () {
    ...
    for (var _i = 0, _a = this.routeTable; _i < _a.length; _i++) {
      ...
      if (routePath.indexOf(routeInfo.path) >= 0) {
        routeInfo.page.render(this.getPathParam(routePath));
        break;
      }
    }
  };
...
function () {
  ...
  Object.defineProperty(Store.prototype, "feedsLength", {
    get: function get() {
  ...
  Object.defineProperty(Store.prototype, "isMaximumPage", {
    get: function get() {
  ...
  Object.defineProperty(Store.prototype, "allFeeds", {
    get: function get() {
      return this.feeds;
    },
    enumerable: false,
  ...
  Object.defineProperty(Store.prototype, "setFeeds", {
    set: function set(feeds) {
      var newFeeds = feeds.map(function (feed) {
        return __assign(__assign({}, feed), {
          read: false
        });
      });
      this.feeds = __spreadArray(__spreadArray([], this.feeds), newFeeds);
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Store.prototype, "makeRead", {
    set: function set(id) {
      console.log(id);
...
function () {
  function View(containerId, template) {
    ...
    if (!containerElement) {
      throw '최상위 컨체이너가 없어UI를 진행하지 못합니다.';
    }
  ...
  function NewsDetailView(containerId, store) {
    ...
    _this.render = function (id) {
      return __awaiter(_this, void 0, Promise, function () {
        var api, _a, title, comments, content;

        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              api = new api_1.NewsDetailApi();
              return [4
              /*yield*/
              , api.getData(config_1.CONTENT_URL.replace('@id', id))];
...
function (_super) {
  ...
  function NewsFeedView(containerId, store) {
    ...
    _this.render = function (page) {
      return __awaiter(_this, void 0, Promise, function () {
        var _a, _b, i, _c, read, id, title, comments_count, user, points, time_ago;

        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              this.store.currentPage = Number(page);
              if (!!this.store.feedsLength) return [3
              /*break*/
              , 2];
              _a = this.store;
              return [4
              /*yield*/
              , this.api.getData(this.makeNewsUrl())];
            ...
            case 2:
              if (!this.store.isMaximumPage) return [3
              /*break*/
              , 4];
              console.log(22, this.maxPage);
              _b = this.store;
              return [4
              /*yield*/
              , this.api.getData(this.makeNewsUrl())];
            ...
            case 4:
              for (i = (this.store.currentPage - 1) * 10; i < this.store.currentPage * 10; i++) {
                _c = this.store.getfeed(i), read = _c.read, id = _c.id, title = _c.title, comments_count = _c.comments_count, user = _c.user, points = _c.points, time_ago = _c.time_ago;
                this.addHtml("\n                <div class=\"p-6 " + (read ? 'bg-red-200' : 'bg-white') + " mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n                    <div class=\"flex\">\n                        <div class=\"flex-auto\">\n                            <a href=\"#/show/" + id + "\">" + title + "</a>\n                        </div>\n                        <div class=\"text-center text-sm\">\n                            <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py2\">" + comments_count + "</div>\n                        </div>\n                    </div>\n                    <div class=\"flex mt-3\">\n                        <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n                            <div><i class=\"fas fa-user mr-1\"></i>" + user + "</div>\n                            <div><i class=\"fas fa-heart mr-1\"></i>" + points + "</div>\n                            <div><i class=\"fas fa-clock mr-1\"></i>" + time_ago + "</div>\n                        </div>\n                    </div>\n                </div>\n            ");
              }
  ...
  NewsFeedView.prototype.makeNewsUrl = function () {
    this.maxPage++;
    console.log(this.maxPage);
    return config_1.NEWS_URL.replace('@page', String(this.maxPage));
  };
...
router.go();
},{"./core/router":"src/core/router.ts","./store":"src/store.ts","./page":"src/page/index.ts"}],"C:/Users/inner_mouse/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/inner_mouse/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
